...
@section('title', __('advertising::dashboard.advertising.routes.create'))
@section('content')
        ...
        <div class="page-content">
            <div class="page-bar">
                <ul class="page-breadcrumb">
                    ...
                    <li>
                        <a href="{{ route('dashboard.advertising.index', ['advertising_group' => $advertisingGroup->id]) }}">
                            {{__('advertising::dashboard.advertising.routes.index')}}
                        </a>
                        <i class="fa fa-circle"></i>
                    </li>
                    <li>
                        <a href="#">{{__('advertising::dashboard.advertising.routes.create')}}</a>
                    </li>
                </ul>
            </div>
            ...
            <div class="row">
                <form id="form" role="form" class="form-horizontal form-row-seperated" method="post"
                      enctype="multipart/form-data" action="{{route('dashboard.advertising.store')}}">
                    @csrf
                    <div class="col-md-12">
                                ...
                                <div class="tab-pane active fade in" id="general">
                                    <div class="col-md-10">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9">
                                                <select name="group_id" class="form-control" data-name="group_id">
                                                    <option value="">
                                                    ...
                                                    @foreach($groups as $k => $group)
                                                        <option
                                                            value="{{ $group->id }}" {{ $advertisingGroup->id == $group->id ? 'selected' : '' }}>
                                                            {{ $group->title }}
                                                        </option>
                                                    @endforeach
                                                </select>
                                            ...
                                            <div class="col-md-9">
                                                ...
                                                <label class="radio-inline">
                                                    <input type="radio" name="link_type" id="externalLinkRadioBtn"
                                                           value="external"
                                                           onclick="toggleLink('external')"
                                                           checked> {{ __('advertising::dashboard.advertising.form.link_type.external') }}
                                                </label>
                                                <label class="radio-inline">
                                        ...
                                        {!! field()->file('image', __('advertising::dashboard.advertising.form.image')) !!}
                                    </div>
                                </div>
                                {{-- END CREATE FORM --}}
