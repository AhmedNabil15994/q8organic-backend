...
@section('title', __('advertising::dashboard.advertising_groups.routes.update'))
@section('content')
        ...
        <div class="page-content">
            <div class="page-bar">
                <ul class="page-breadcrumb">
                    ...
                    <li>
                        <a href="#">{{__('advertising::dashboard.advertising_groups.routes.update')}}</a>
                    </li>
                </ul>
            </div>
            ...
            <div class="row">
                <form id="updateForm" page="form" class="form-horizontal form-row-seperated" method="post"
                      ...
                      action="{{route('dashboard.advertising_groups.update',$adGroup->id)}}">
                    @csrf
                    @method('PUT')
                    <div class="col-md-12">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-9">
                                                            <input type="text" name="title[{{$code}}]"
                                                                   ...
                                                                   value="{{ $adGroup->getTranslation('title', $code) }}">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9">
                                                    <select name="position" class="form-control" data-name="position">
                                                        ...
                                                        <option
                                                            value="home" {{ $adGroup->getOriginal('position') == 'home' ? 'selected' : '' }}>{{ __('advertising::dashboard.advertising_groups.form.position.home') }}</option>
                                                        <option
                                                            value="categories" {{ $adGroup->getOriginal('position') == 'categories' ? 'selected' : '' }}>{{ __('advertising::dashboard.advertising_groups.form.position.categories') }}</option>
                                                    </select>
                                                    <div class="help-block"></div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9">
                                                    <input type="checkbox" class="make-switch" id="test"
                                                           data-size="small"
                                                           name="status" {{($adGroup->status == 1) ? ' checked="" ' : ''}}>
                                                    <div class="help-block"></div>
                                                </div>
                                            </div>
