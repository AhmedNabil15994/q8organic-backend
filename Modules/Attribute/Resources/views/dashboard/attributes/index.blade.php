                    ...
                    <div class="portlet light bordered">
                        ...
                        <div class="table-toolbar">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="btn-group">
                                        <a href="{{ url(route('dashboard.attributes.create')) }}"
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="">
                                                                    <select class="form-control" name="type">
                                                                        <option
                                                                            value="">{{__('apps::dashboard.datatable.all')}}</option>
                        ...
                        <div class="portlet-body">
                            <table class="table table-striped table-bordered table-hover" id="dataTable">
                                ...
                                <tr>
                                    ...
                                    <th>#</th>
                                    <th>{{__('attribute::dashboard.attributes.datatable.sort')}}</th>
