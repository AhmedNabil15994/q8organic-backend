...
@section('title', __('order::dashboard.order_statuses.index.title'))
@section('content')
        ...
        <div class="page-content">
            <div class="page-bar">
                <ul class="page-breadcrumb">
                    ...
                    <li>
                        <a href="#">{{__('order::dashboard.order_statuses.index.title')}}</a>
                    </li>
                </ul>
            </div>
...
responsivePriority: 1,
                            ...
                            render: function (data, type, full, meta) {
                                ...
                                var deleteBtn = `@permission('delete_order_statuses')
                                @csrf
                                ...
                                if (!['pending', 'cancelled', 'refund', 'success', 'failed', 'delivered', 'new_order'].includes(full.flag))
                                    buttons += deleteBtn;
