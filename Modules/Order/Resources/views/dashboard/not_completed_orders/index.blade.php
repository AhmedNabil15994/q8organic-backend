...
@section('title', __('order::dashboard.orders.not_completed_orders.title'))
@section('content')
        ...
        <div class="page-content">
            <div class="page-bar">
                <ul class="page-breadcrumb">
                    ...
                    <li>
                        <a href="#">{{__('order::dashboard.orders.not_completed_orders.title')}}</a>
                    </li>
                </ul>
            </div>
        ...
        function tableGenerate(data = '') {
            ...
            var dataTable =
                $('#dataTable').DataTable({
                    ...
                    ajax: {
                        url: "{{ url(route('dashboard.not_completed_orders.datatable')) }}",
                        type: "GET",
                        data: {
                            req: data,
                        },
...
responsivePriority:1,
                            ...
                            render: function (data, type, full, meta) {
                                ...
                                // Show
                                var showUrl = '{{ route("dashboard.orders.show", [":id", "not_completed_orders"]) }}';
                    ...
                    buttons: [
                        ...
                        },
                        {
                            ...
                            url: "{{url(route('dashboard.not_completed_orders.export' , 'print'))}}",
                            data: {
                                req: data,
                            },
                            exportOptions: {
                        ...
                        },
                        {
                            ...
                            url: "{{url(route('dashboard.not_completed_orders.export' , 'pdf'))}}",
                            data: {
                                req: data,
                            },
                            exportOptions: {
                        ...
                        },
                        {
                            ...
                            url: "{{url(route('dashboard.not_completed_orders.export' , 'excel'))}}",
                            data: {
                                req: data,
                            },
                            exportOptions: {
