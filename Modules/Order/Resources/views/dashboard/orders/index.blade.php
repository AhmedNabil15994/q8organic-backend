                ...
                $('#dataTable').DataTable({
                    ...
                    buttons: [{
                        ...
                        },
                        {
                            ...
                            url: "{{url(route('dashboard.current_orders.export' , 'print'))}}",
                            data: {
                                req: data,
                            },
                            exportOptions: {
                        ...
                        },
                        {
                            ...
                            url: "{{url(route('dashboard.current_orders.export' , 'pdf'))}}",
                            data: {
                                req: data,
                            },
                            exportOptions: {
                        ...
                        },
                        {
                            ...
                            url: "{{url(route('dashboard.current_orders.export' , 'excel'))}}",
                            data: {
                                req: data,
                            },
                            exportOptions: {
