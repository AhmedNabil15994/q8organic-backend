...
@section('title', __('user::dashboard.drivers.index.title'))
@section('content')
        ...
        <div class="page-content">
            <div class="page-bar">
                <ul class="page-breadcrumb">
                    ...
                    <li>
                        <a href="#">{{__('user::dashboard.drivers.index.title')}}</a>
                    </li>
                </ul>
            </div>
                    ...
                    <div class="portlet light bordered">
                        ...
                        <div class="table-toolbar">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="btn-group">
                                        <a href="{{ url(route('dashboard.drivers.create')) }}" class="btn sbold green">
                        ...
                        <div class="portlet-body">
                            <table class="table table-striped table-bordered table-hover" id="dataTable">
                                ...
                                <tr>
                                    ...
                                    <th>#</th>
                                    <th>{{__('user::dashboard.drivers.datatable.image')}}</th>
                                    <th>{{__('user::dashboard.drivers.datatable.name')}}</th>
                                    <th>{{__('user::dashboard.drivers.datatable.email')}}</th>
                                    {{--<th>{{__('user::dashboard.drivers.datatable.mobile')}}</th>--}}
                                    <th>{{__('user::dashboard.drivers.datatable.company')}}</th>
                                    <th>{{__('user::dashboard.drivers.datatable.created_at')}}</th>
                                    <th>{{__('user::dashboard.drivers.datatable.options')}}</th>
                                </tr>
                                </thead>
                            </table>
                        </div>
                        <div class="row">
                            <div class="form-group">
                                <button type="submit" id="deleteChecked" class="btn red btn-sm"
                                        onclick="deleteAllChecked('{{ url(route('dashboard.drivers.deletes')) }}')">
        ...
        function tableGenerate(data = '') {
            ...
            var dataTable =
                $('#dataTable').DataTable({
                    ...
                    ajax: {
                        url: "{{ url(route('dashboard.drivers.datatable')) }}",
                        type: "GET",
                        data: {
                            req: data,
                        },
...
responsivePriority: 1,
                            width: '13%',
                            title: '{{__('user::dashboard.drivers.datatable.options')}}',
                            className: 'dt-center',
                            orderable: false,
                            render: function (data, type, full, meta) {

                                // Edit
                                var editUrl = '{{ route("dashboard.drivers.edit", ":id") }}';
                                editUrl = editUrl.replace(':id', data);

                                // Delete
                                var deleteUrl = '{{ route("dashboard.drivers.destroy", ":id") }}';
