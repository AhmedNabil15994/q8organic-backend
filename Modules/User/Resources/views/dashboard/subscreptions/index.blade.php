...
@section('title', __('user::dashboard.subscribe.routes.index'))
@section('content')
        ...
        <div class="page-content">
            <div class="page-bar">
                <ul class="page-breadcrumb">
                    ...
                    <li>
                        <a href="#">{{__('user::dashboard.subscribe.routes.index')}}</a>
                    </li>
                </ul>
            </div>
                        ...
                        <div class="portlet-body">
                            <table class="table table-striped table-bordered table-hover" id="dataTable">
                                ...
                                <tr>
                                    ...
                                    <th>#</th>
                                    <th>{{__('user::dashboard.subscribe.datatable.email')}}</th>
                                    <th>{{__('user::dashboard.subscribe.datatable.created_at')}}</th>
                                    <th>{{__('user::dashboard.subscribe.datatable.options')}}</th>
                                </tr>
                                </thead>
                            </table>
                        </div>
                        <div class="row">
                            <div class="form-group">
                                <button type="submit" id="deleteChecked" class="btn red btn-sm"
                                        onclick="deleteAllChecked('{{ url(route('dashboard.subscribes.deletes')) }}')">
        ...
        function tableGenerate(data = '') {
            ...
            var dataTable =
                $('#dataTable').DataTable({
                    ...
                    ajax: {
                        url: "{{ url(route('dashboard.subscribes.datatable')) }}",
                        type: "GET",
                        data: {
                            req: data,
                        },
                  ...
                  `;
                        ...
                        },
                        {
                            ...
                            render: function (data, type, full, meta) {
                                // Delete
                                var deleteUrl = '{{ route("dashboard.subscribes.destroy", ":id") }}';
