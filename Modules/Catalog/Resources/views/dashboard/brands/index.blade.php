...
@section('title', __('catalog::dashboard.brands.routes.index'))
@section('content')
    ...
    <div class="page-content">
        <div class="page-bar">
            <ul class="page-breadcrumb">
                ...
                <li>
                    <a href="#">{{__('catalog::dashboard.brands.routes.index')}}</a>
                </li>
            </ul>
        </div>
                        ...
                        <table class="table table-striped table-bordered table-hover" id="dataTable">
                            <thead>
                                <tr>
                                    ...
                                    <th>#</th>
                                    <th>{{__('catalog::dashboard.brands.datatable.image')}}</th>
                                    <th>{{__('catalog::dashboard.brands.datatable.status')}}</th>
                                    <th>{{__('catalog::dashboard.brands.datatable.title')}}</th>
                                    <th>{{__('catalog::dashboard.brands.datatable.created_at')}}</th>
                                    <th>{{__('catalog::dashboard.brands.datatable.options')}}</th>
                                </tr>
                            </thead>
                        </table>
                    </div>
...
responsivePriority: 1,
              width: '13%',
              title: '{{__('catalog::dashboard.brands.datatable.options')}}',
              className: 'dt-center',
              orderable: false,
              render: function(data, type, full, meta) {
