...
@section('title', __('catalog::dashboard.brands.routes.update'))
@section('content')
        ...
        <div class="page-content">
            <div class="page-bar">
                <ul class="page-breadcrumb">
                    ...
                    <li>
                        <a href="#">{{__('catalog::dashboard.brands.routes.update')}}</a>
                    </li>
                </ul>
            </div>
            ...
            <div class="row">
                <form id="updateForm" page="form" class="form-horizontal form-row-seperated" method="post"
                      enctype="multipart/form-data" action="{{route('dashboard.brands.update',$model->id)}}">
                    @csrf
                    @method('PUT')
                    <div class="col-md-12">
                                    ...
                                    <div class="col-md-10">
                                        ...
                                        @foreach (config('translatable.locales') as $code)
                                           ...
                                           __('catalog::dashboard.brands.form.short_description').'-'.$code ,
                                            $model->getTranslation('short_description',$code),
                                        ...
                                        {!! field()->file('image', __('catalog::dashboard.brands.form.image'), $model->image ? asset($model->image) : null) !!}
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9">
                                                    <textarea name="seo_keywords[{{$code}}]" rows="8" cols="80"
                                                              class="form-control"
                                                              data-name="seo_keywords.{{$code}}">{{ $model->getTranslation('seo_keywords',$code) }}</textarea>
                                                    <div class="help-block"></div>
                                                </div>
                                            </div>
                                        @endforeach
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9">
                                                    <textarea name="seo_description[{{$code}}]" rows="8" cols="80"
                                                              class="form-control"
                                                              data-name="seo_description.{{$code}}">{{ $model->getTranslation('seo_description',$code) }}</textarea>
                                                    <div class="help-block"></div>
                                                </div>
                                            </div>
                                        @endforeach
