                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="btn-group">
                                        ...
                                        'module_name' => 'Catalog',
                                        'view_path' => 'categories.import-cols-selectors',
                                        ])
                                                ...
                                                <div class="form-body">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                                <label class="control-label">
                                                                    {{__('catalog::dashboard.categories.form.category_type')}}
                                                                </label>
                                                                <select name="category_type" class="form-control">
                                                                    <option value="">
                                                                        ---
                                                                        {{__('catalog::dashboard.categories.form.all')}}
                                                                        ---
                                                                    </option>
                                                                    <option value="main_category">
                                                                        {{__('catalog::dashboard.categories.form.main_category_only')}}
                                                                    </option>
                                                                    <option value="sub_category">
                                                                        {{__('catalog::dashboard.categories.form.sub_category_only')}}
                                                                    </option>
                                                                </select>
                                                            </div>
                                                        </div>
...
@section('scripts')
    ...
    @include('apps::dashboard.components.datatable.image-uploading.scripts',['uploading_route' => route('dashboard.categories.update.photo')])

    @include('apps::dashboard.components.import-excel-scripts',[
        'route' => route('dashboard.categories.import.excel')
    ])
    <script>
...
responsivePriority: 1,
                    ...
                    buttons: [
                        ...
                        },
                        {
                            ...
                            url: "{{url(route('dashboard.categories.export' , 'print'))}}",
                            data: {
                                req: data,
                            },
                            exportOptions: {
                        ...
                        },
                        {
                            ...
                            url: "{{url(route('dashboard.categories.export' , 'pdf'))}}",
                            data: {
                                req: data,
                            },
                            exportOptions: {
                        ...
                        },
                        {
                            ...
                            url: "{{url(route('dashboard.categories.export' , 'excel'))}}",
                            data: {
                                req: data,
                            },
                            exportOptions: {
