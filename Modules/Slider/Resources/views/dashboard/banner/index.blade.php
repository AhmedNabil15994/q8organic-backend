...
@section('title', __('slider::dashboard.banner.routes.index'))
@section('content')
        ...
        <div class="page-content">
            <div class="page-bar">
                <ul class="page-breadcrumb">
                    ...
                    <li>
                        <a href="#">{{__('slider::dashboard.banner.routes.index')}}</a>
                    </li>
                </ul>
            </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="portlet light bordered">
                        ...
                        @permission('add_banner')
                        <div class="table-toolbar">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="btn-group">
                                        <a href="{{ url(route('dashboard.banner.create')) }}" class="btn sbold green">
                        ...
                        <div class="portlet-body">
                            <table class="table table-striped table-bordered table-hover" id="dataTable">
                                ...
                                <tr>
                                    ...
                                    <th>#</th>
                                    <th>{{__('slider::dashboard.banner.datatable.image')}}</th>
                                    <th>{{__('slider::dashboard.banner.datatable.status')}}</th>
                                    <th>{{__('slider::dashboard.banner.datatable.type')}}</th>
                                    <th>{{__('slider::dashboard.banner.datatable.start_at')}}</th>
                                    <th>{{__('slider::dashboard.banner.datatable.end_at')}}</th>
                                    <th>{{__('slider::dashboard.banner.datatable.created_at')}}</th>
                                    <th>{{__('slider::dashboard.banner.datatable.options')}}</th>
                                </tr>
                                </thead>
                            </table>
                        </div>
                        <div class="row">
                            <div class="form-group">
                                <button type="submit" id="deleteChecked" class="btn red btn-sm"
                                        onclick="deleteAllChecked('{{ url(route('dashboard.banner.deletes')) }}')">
        ...
        function tableGenerate(data = '') {
            ...
            var dataTable =
                $('#dataTable').DataTable({
                    ...
                    ajax: {
                        url: "{{ url(route('dashboard.banner.datatable')) }}",
                        type: "GET",
                        data: {
                            req: data,
                        },
...
responsivePriority: 1,
                            width: '13%',
                            title: '{{__('slider::dashboard.banner.datatable.options')}}',
                            className: 'dt-center',
                            orderable: false,
                            render: function (data, type, full, meta) {

                                // Edit
                                var editUrl = '{{ route("dashboard.banner.edit", ":id") }}';
                                editUrl = editUrl.replace(':id', data);

                                // Delete
                                var deleteUrl = '{{ route("dashboard.banner.destroy", ":id") }}';
