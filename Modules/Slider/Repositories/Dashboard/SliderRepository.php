    ...
    public function create($request)
    {
        ...
        try {
            $data = [
                ...
                'image' => $request->image ? Attachment::addAttachment($request['image'],'sliders') : config('setting.logo'),
    ...
    public function update($request, $id)
    {
        ...
        try {
            $data = [
                'start_at' => $request->start_at,
                'end_at' => $request->end_at,
                'image' => $request->image ? Attachment::updateAttachment($request['image'] , $Slider->image,'sliders') : $Slider->image,
                'status' => $request->status ? 1 : 0,
                "short_title" => $request->short_title,
                "short_description" => $request->short_description,
                "title" => $request->title,
