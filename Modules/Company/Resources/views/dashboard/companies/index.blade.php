                ...
                <div class="col-md-12">
                    <div class="portlet light bordered">
                        ...
                        @if(config('setting.other.add_shipping_company') == 1)
                            @permission('add_companies')
                            <div class="table-toolbar">
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="btn-group">
                                            <a href="{{ url(route('dashboard.companies.create')) }}"
                        ...
                        },
                        {
                            ...
                            render: function (data, type, full, meta) {
                                ...
                                return `
                                    ...
                                    @csrf
                                    <a href="javascript:;" onclick="deleteRow('` + deleteUrl + `')" class="btn btn-sm red btnRemove">
