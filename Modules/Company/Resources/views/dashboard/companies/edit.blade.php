                            ...
                            <div class="tab-content">
                                ...
                                <div class="tab-pane active fade in" id="global_setting">
                                    ...
                                    <div class="tab-content px-1 pt-1">
                                        ...
                                        @foreach (config('translatable.locales') as $k => $code)
                                            <div role="tabpanel"
                                                ...
                                                <div class="col-md-12">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-9">
                                                            <input type="text" name="name[{{$code}}]"
                                                                   class="form-control"
                                                                   data-name="name.{{$code}}"
                                                                   value="{{ $company->getTranslation('name',$code) }}">
                                                    ...
                                                    $company->getTranslation('description',$code)); !!}
                                        ...
                                        {!!  field()->multiSelect('countries', __('company::dashboard.companies.form.countries'),
                                            $supported_countries->pluck('title','id')->toArray(),
                                            $company->countries()->count() ? $company->countries->pluck('id')->toArray() : null
                                        ,['autocomplete'=>'off'])!!}
                                        <div class="col-md-12">
                                            ...
                                            {!! field()->file('image', __('company::dashboard.companies.form.image'), $company->image ? asset($company->image) : null) !!}
