...
@section('title', __('tags::dashboard.tags.routes.update'))
@section('content')
        ...
        <div class="page-content">
            <div class="page-bar">
                <ul class="page-breadcrumb">
                    ...
                    <li>
                        <a href="#">{{__('tags::dashboard.tags.routes.update')}}</a>
                    </li>
                </ul>
            </div>
            ...
            <div class="row">
                <form id="updateForm" page="form" class="form-horizontal form-row-seperated" method="post"
                      enctype="multipart/form-data" action="{{route('dashboard.tags.update',$tag->id)}}">
                    @csrf
                    @method('PUT')
                    <div class="col-md-12">
                                    ...
                                    <div class="tab-content px-1 pt-1">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-9">
                                                            <input type="text" name="title[{{$code}}]"
                                                                   ...
                                                                   value="{{ $tag->getTranslation('title',$code) }}">
                                        ...
                                        <div class="col-md-10">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9">
                                                    @include('core::dashboard.shared.file_upload', ['image' => $tag->image])
                                                    <div class="help-block"></div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9">
                                                    <input type="checkbox" class="make-switch" id="test"
                                                           data-size="small"
                                                           name="status" {{($tag->status == 1) ? ' checked="" ' : ''}}>
                                                    <div class="help-block"></div>
                                                </div>
                                            </div>
