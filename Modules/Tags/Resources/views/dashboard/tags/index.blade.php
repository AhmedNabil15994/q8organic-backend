...
@section('title', __('tags::dashboard.tags.routes.index'))
@section('content')
        ...
        <div class="page-content">
            <div class="page-bar">
                <ul class="page-breadcrumb">
                    ...
                    <li>
                        <a href="#">{{__('tags::dashboard.tags.routes.index')}}</a>
                    </li>
                </ul>
            </div>
                        ...
                        <div class="portlet-body">
                            <table class="table table-striped table-bordered table-hover" id="dataTable">
                                ...
                                <tr>
                                    ...
                                    <th>#</th>
                                    <th>{{__('tags::dashboard.tags.datatable.title')}}</th>
                                    <th>{{__('tags::dashboard.tags.datatable.status')}}</th>
                                    <th>{{__('tags::dashboard.tags.datatable.created_at')}}</th>
                                    <th>{{__('tags::dashboard.tags.datatable.options')}}</th>
                                </tr>
                                </thead>
                            </table>
                        </div>
...
responsivePriority: 1,
                            width: '210px',
                            title: '{{__('tags::dashboard.tags.datatable.options')}}',
                            className: 'dt-center',
                            orderable: false,
                            render: function (data, type, full, meta) {
