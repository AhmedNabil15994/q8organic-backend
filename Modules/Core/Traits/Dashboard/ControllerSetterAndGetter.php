...
trait ControllerSetterAndGetter
{
    ...
    protected function setResource($resource = null)
    {
        if ($resource) {
            ...
            $this->export_resource = get_class($resource);
        } else {
    ...
    protected function setExportResource($resource = null)
    {
        if ($resource) {
            $this->export_resource = get_class($resource);
        } else {
            ...
            if (class_exists($class)) {
                ...
                $this->export_resource = $class;
            } else {

                $this->export_resource = 'Modules\Core\Transformers\''.Str::ucfirst($this->folder).'\DefaultResource';
            }
        }
