...
@section('title', __('wrapping::dashboard.cards.routes.update'))
@section('content')
        ...
        <div class="page-content">
            <div class="page-bar">
                <ul class="page-breadcrumb">
                    ...
                    <li>
                        <a href="#">{{__('wrapping::dashboard.cards.routes.update')}}</a>
                    </li>
                </ul>
            </div>
            ...
            <div class="row">
                <form id="updateForm" page="form" class="form-horizontal form-row-seperated" method="post"
                      enctype="multipart/form-data" action="{{route('dashboard.cards.update',$card->id)}}">
                    @csrf
                    @method('PUT')
                    <div class="col-md-12">
                                    ...
                                    <div class="tab-content px-1 pt-1">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-9">
                                                            <input type="text" name="title[{{$code}}]"
                                                                   ...
                                                                   value="{{ $card->getTranslation('title',$code)}}">
                                        ...
                                        <div class="col-md-10">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <img src="{{ url($card->image) }}" alt="" style="height: 15rem;">
                                            </span>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9">
                                                    <input type="checkbox" class="make-switch" id="test"
                                                           data-size="small"
                                                           name="status" {{($card->status == 1) ? ' checked="" ' : ''}}>
                                                    <div class="help-block"></div>
                                                </div>
                                            </div>
                                        </div>
