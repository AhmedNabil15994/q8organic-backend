<div class="page-header navbar navbar-fixed-top">
    <div class="page-header-inner ">
        <div class="page-logo">
            <a href="{{url(route('developer.home'))}}">
            </a>
                        ...
                        <li>
                            <a href="#"
                               onclick="event.preventDefault();document.getElementById('logout-form').submit();">
                                <i class="icon-key"></i> {{ __('developertools::developer.navbar.logout') }}
                            </a>
                            <form id="logout-form" action="{{ route('developer.logout') }}" method="POST"
                                  style="display: none;">
                                @csrf
                            </form>
                        </li>
