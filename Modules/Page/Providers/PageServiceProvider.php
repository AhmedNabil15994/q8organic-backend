...
class PageServiceProvider extends ServiceProvider
{
    ...
    {
        $this->publishes([
            module_path('Page', 'Config/config.php') => config_path('page.php'),
        ], 'config');
        $this->mergeConfigFrom(
            module_path('Page', 'Config/config.php'), 'page'
        );
    }
    ...
    public function registerTranslations()
    {
        ...
        if (is_dir($langPath)) {
            ...
            $this->loadTranslationsFrom(module_path('Page', 'Resources/lang'), 'page');
        }
    }
    ...
    public function registerFactories()
    {
        if (! app()->environment('production') && $this->app->runningInConsole()) {
            $this->loadFactoriesFrom(module_path('Page', 'Database/factories'));
        }
    }
